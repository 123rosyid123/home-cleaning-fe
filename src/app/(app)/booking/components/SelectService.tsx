...
export default function SelectService() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      ...
      <div className="bg-white rounded-[32px] p-6 sm:p-10 shadow-xl border border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {frequencies.map((freq) => (
            ...
            >
              <div className={`border rounded-[24px] p-5 sm:p-6 h-full flex flex-col
                ${frequency === freq.id ? 'border-primary/20' : 'border-gray-200'}`}>
                <div className="h-8 mb-3">
                  {freq.badge && (
                    <span className="inline-block bg-primary/10 text-primary text-[10px] px-2 py-1 sm:text-sm sm:px-4 sm:py-1.5 rounded-full font-medium">
                      {freq.badge}
                    </span>
                  )}
                </div>
        ...
        <p className="text-sm text-gray-600 mt-6 sm:mt-8 bg-primary/5 p-5 sm:p-6 rounded-[20px] border border-primary/20 leading-relaxed">
